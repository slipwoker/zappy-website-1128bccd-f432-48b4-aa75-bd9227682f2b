document.addEventListener('DOMContentLoaded', function () {
  ...
  if (contactForm) {
    ...
    contactForm.addEventListener('submit', function (e) {
      ...
      const successEl = contactForm.querySelector('.form-success-message');
      if (successEl) {
        successEl.remove();
      }
      ...
      fetch(action, {
        ...
        .catch(function () {
          ...
          const existingErr = contactForm.querySelector('.form-submit-error');
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "סהר מערכות משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '1128bccd-f432-48b4-aa75-bd9227682f2b',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '1128bccd-f432-48b4-aa75-bd9227682f2b';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '1128bccd-f432-48b4-aa75-bd9227682f2b';
